    ...
    async getDirections(startLoc, destLoc) {
        try {
            ...
            this.setState({
                ...
                fareCost: fareCalculation ? fareCalculation.totalCost.toFixed(2) : 0,
                estimateFare: fareCalculation ? fareCalculation.grandTotal.toFixed(2) : 0,
                ...
                if (flag == true) {
                    ...
                    this.setState({ modalVisible: false }, () => {
                        ...
                        var data = {
                            ...
                            estimate: this.state.estimateFare,
                            otp: otp,
                            convenience_fees: this.state.rateDetails.convenience_fees
                        }
                            ...
                            <View style={styles.upperContainer}>
                                <View style={styles.fareDetailsContainer}>
                                    ...
                                    <View style={styles.farePriceContainer}>
                                        <Text style={styles.farePriceText}>{Currency} {this.state.fareCost} </Text>
                                        <Text style={styles.farePriceText}>{Currency} {this.state.rateDetails ? this.state.rateDetails.convenience_fees.toFixed(2) : 0} </Text>
                                    </View>
                                </View>
                                ...
                                <View style={styles.totalPriceContainer}>
                                    ...
                                    <View style={styles.totalPriceNumberContainer}>
                                        ...
                                        <Text style={styles.totalPriceNumber}>{Currency}{this.state.estimateFare}</Text>
                    ...
                    <View style={styles.priceDetailsContainer}>
                        <View style={styles.priceDetailsLeft}>
                            ...
                            <View style={styles.iconContainer}>
                                <Text style={styles.priceText}> {Currency} {this.state.estimateFare}</Text>
                            </View>
