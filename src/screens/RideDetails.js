                ...
                <ScrollView>
                    ...
                    <View style={styles.rideDesc}>
                        ...
                        <Avatar
                            ...
                            /> */}
                            <View style={styles.userView}>
                        <Text style={styles.textStyle}>{Currency}{this.state.paramData && this.state.paramData.trip_cost>0?this.state.paramData.trip_cost.toFixed(2):this.state.paramData && this.state.paramData.estimate?this.state.paramData.estimate:0 }</Text>
                            </View>
                        </View>
                    </View> 
                   ...
                   />
                    ...
                    <View style={styles.billView}>
                        ...
                        <Text style={styles.billAmount}>{Currency} {this.state.paramData && this.state.paramData.trip_cost>0?this.state.paramData.trip_cost.toFixed(2):this.state.paramData && this.state.paramData.estimate?this.state.paramData.estimate.toFixed(2):0 }</Text>
                            </View>
                            <View style={styles.billItem}>
                                <View>
                        ...
                        <Text style={styles.discountAmount}> - {Currency}{this.state.paramData && this.state.paramData.discount_amount?this.state.paramData.discount_amount.toFixed(2):0}</Text>
                            </View>
                        </View>
                        <View style={styles.paybleAmtView}>
                            <Text style={styles.billTitle}>{languageJSON.grand_total}</Text>
                        <Text style={styles.billAmount2}>{Currency}{this.state.paramData && this.state.paramData.trip_cost?this.state.paramData.trip_cost.toFixed(2):null}</Text>
                        </View>
                    </View>
                    :null:null}
                     {this.state.paramData && this.state.paramData.payment_status?this.state.paramData.payment_status == "IN_PROGRESS" || this.state.paramData.payment_status == "PAID" || this.state.paramData.payment_status == "WAITING"?
                            ...
                            {this.state.paramData && this.state.paramData.payment_status?
                                <View style={styles.billOptions}>
                                    <View style={styles.billItem}>
                                        ...
                                        <Text style={styles.billName}>{this.state.paramData.payment_mode?this.state.paramData.payment_mode:null}</Text>
                                    </View>
                                </View>
                            :<View style={styles.billOptions}>
