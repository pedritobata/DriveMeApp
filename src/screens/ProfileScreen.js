...
async uploadmultimedia(url){
 ...
 onPressChangePassword(oldPass,newPass){
    firebase.auth().signInWithEmailAndPassword(this.state.currentUser.email,oldPass).then((res)=>{
     if(res){
        //alert('Sorrry! \n This feature is available in source code but blocked in demo')
        /* remove the comments for change password feature*/
        ...
        Alert.alert(
            ...
            [
              ...
              {text: languageJSON.yes, onPress: () =>
                {
                    //alert('Sorrry! \n This feature is available in source code but blocked in demo ')
                    /* please remove the comments for delete user feature */
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={styles.scrollStyle}>
               {
                ...
                <View style={styles.scrollViewStyle} >
                    <Text style={styles.profStyle}> {languageJSON.my_wallet_title} ( {Currency} {this.state.walletBalance?this.state.walletBalance.toFixed(2):0.00})</Text>
                    <Icon
                ...
                <View style={styles.flexView3}>
                    <TouchableOpacity style={styles.textIconStyle}  onPress={()=>{this.ShowchangePasswordModal()}}>
                        <Text style={styles.emailStyle}>{languageJSON.change_password_lebel}</Text>
                        <Icon
